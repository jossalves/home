	...
	<div id="wrapper" class="{select:Post title style}">
		<div id="content" role="main">
			...
			" data-tags="{TagsAsClasses} null">
				...
				{block:Date}{block:IndexPage}{block:IfPostTextButtons}
